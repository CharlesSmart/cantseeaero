  ...
  useEffect(() => {
    const loadProfiles = async () => {
      ...
      const profilesWithBlobUrls = storedProfiles.map(profile => {
        const uploadedImageUrlfromIDB = profile.uploadedImageUrl ? URL.createObjectURL(new Blob([profile.imageUrl])) : null;
        const cachedImageUrlfromIDB = profile.cachedImageUrl ? URL.createObjectURL(new Blob([profile.cachedImageUrl])) : null;
        return {
          ...profile,
