...
import { PlusIcon, PanelLeftClose, PanelLeft, Link } from 'lucide-react';
    ...
    <div>
        ...
        <hr className='-mx-4'></hr>
            <div className='flex flex-col gap-2'>
                <div className='flex flex-row gap-2'><h3 className='text-lg font-semibold'>Measurements</h3><Button variant='secondary'><Link className='w-3 h-3'/></Button></div>
