          ...
          {profiles.map(profile => (
            ...
            >
              ...
              <div className='flex grow justify-end'>
                <div onClick={() => onDeleteProfile(profile.id)}  className='flex h-8 w-8 self-center content-center gap-2 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200'><Trash className='w-4 h-4 text-muted-foreground self-center'/></div>
              </div>
            </TabsTrigger>
          ))}
        </TabsList>
