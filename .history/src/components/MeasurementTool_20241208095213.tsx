      ...
      {imageUrl && ( 
        <>
          ...
          <ToggleGroup defaultValue="move" type="single" onValueChange={(value) => setSelectedTool(value as 'move' | 'ruler')}>
              <ToggleGroupItem value="move" className='gap-2'><MousePointer2 className="w-4 h-4" /><span className='w-0 opacity-0 hover:w-full hover:opacity-100'>Move</span></ToggleGroupItem>
