        ...
        <TabsList>
          ...
          {profiles.map(profile => (
            ...
            >
              ...
              <a onClick={() => onDeleteProfile(profile.id)}  className='justify-self-end gap-2 -mr-2 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200'><Trash className='w-4 h-4 text-muted-foreground'/></a>
