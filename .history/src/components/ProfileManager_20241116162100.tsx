            ...
            >
              ...
              <>
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      <p>Pixel details: {profile.pixelCounts?.opaquePercentage ?? 0}% opaque, {profile.pixelCounts?.semiTransparentPercentage ?? 0}% semi-transparent, {profile.pixelCounts?.transparentPercentage ?? 0}% transparent</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>
                </>
