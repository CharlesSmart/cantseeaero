...
const AnalysisPanel: React.FC<AnalysisPanelProps> = ({
    ...
    return (
        <Card className='max-w-sm fixed left-4 top-4 backdrop-blur-md bg-white/10'>
        ...
        <hr></hr>
            <div className='flex flex-col gap-4'>
                ...
                <DataRowWithInput label={'Actual Length (mm):'} value={measurementMm ?? ' '} onChange={handleActualLengthChange} disabled={false} unit={'mm'}></DataRowWithInput>
            </div>
            <AreaCalculator 
