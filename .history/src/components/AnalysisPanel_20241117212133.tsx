    ...
    <div>
        ...
        <Card className='max-w-xs max-h-[calc(100vh-2rem)] overflow-y-auto fixed left-4 top-4'>
            <CardHeader className='pb-0'>
                ...
                <Button variant="ghost" onClick={togglePanelVisibility} className='justify-self-end gap-2 -mr-2 px-2'>
                    <PanelLeftClose className='w-4 h-4 text-muted-foreground'/>
                    </Button>
                <div className='grid grid-cols-2 items-center'>
                    <h3 className='text-lg font-semibold'>Positions</h3>
                    <Button variant="ghost" onClick={onAddProfile} className='justify-self-end gap-2 -mr-2 px-2 hover:bg-transparent'>
