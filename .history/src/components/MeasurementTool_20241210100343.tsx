    ...
    <div>
      {imageUrl && ( 
        <>
          ...
          {/* Hardcoded walkthrough steps */}
          {profiles.every(profile => profile.measurementMm === null) && (
            <CardHeader className='flex flex-col gap-2 pb-0'>
              <div className="">
                <Badge variant="info">2</Badge>
                <h3 className='text-lg font-semibold'>Measure a known length</h3>
                <p className='text-sm text-gray-500 max-w-sm'>Use the ruler tool to measure a length in pixels. <br />Then enter the known length in mm</p>
          ...
          {profiles.every(profile => profile.cachedImageUrl === null) && (
            <CardHeader className='flex flex-col gap-2 pb-0'>
              <div className="">
                ...
                <h3 className='text-lg font-semibold'>Remove the background</h3>
                <p className='text-sm text-gray-500 max-w-sm'>Remove the background of the image to get a better measurement</p>
                <hr className='-mx-4 mt-4' />
              </div>
            </CardHeader>
          )}
