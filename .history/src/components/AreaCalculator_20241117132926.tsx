  ...
  return (
    <div className="">
        ...
        <div className='flex flex-col gap-2'>
          <DataRowWithInput label={'Frontal area'} value={areaM2?.toFixed(2)} onChange={() => {}} onBlur={() => {}} disabled={true} unit={'m²'}/>
          <DataRowWithInput label={'Drag (Cd)'} value={cd} onBlur={(e) => setCd(parseFloat(e.target.value))} onChange={() => {}} disabled={false} unit={' '}/>
