          ...
          {profiles.map(profile => (
            ...
            >
              ...
              <div className='grid grid-cols-3'>
                ...
                <div className='flex items-center gap-1'><div className="h-2 w-2 rounded-full bg-primary opacity-50"></div>{Math.round(profile.pixelCounts?.semiTransparentPercentage ?? 0)}%</div>
