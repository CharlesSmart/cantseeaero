      ...
      {imageUrl && ( 
        <>
          ...
          <ToggleGroup defaultValue="move" type="single" onValueChange={(value) => setSelectedTool(value as 'move' | 'ruler')}>
              <ToggleGroupItem value="move" className='gap-2'><MousePointer2 className="w-4 h-4" /><span className='w-0 opacity-0 group-hover:w-full group-hover:opacity-100'>Move</span></ToggleGroupItem>
              <ToggleGroupItem value="ruler" className='gap-2 group'><Ruler className="w-4 h-4" /><span className='w-0 hover:w-full transition-all duration-300'>Ruler</span></ToggleGroupItem>
            </ToggleGroup>
