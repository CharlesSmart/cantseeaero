      ...
      {imageUrl && ( // Check if imageUrl is provided
        <>
          ...
          <ToggleGroup type="single">
              <ToggleGroupItem value="a" className='gap-2'><MousePointer2 className="w-4 h-4" />Move</ToggleGroupItem>
              <ToggleGroupItem value="b"><Ruler className="w-4 h-4 gap-2" />Ruler</ToggleGroupItem>
            </ToggleGroup>
