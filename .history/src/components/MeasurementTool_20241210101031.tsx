...
// Redraw after mouse down/up
  ...
  const onboardingSteps = [
    ...
    {
      condition: (profiles: Profile[]) => profiles.every(profile => profile.cachedImageUrl === null),
      badge: "3",
      title: "Remove the background",
      description: "To get a frontal area estimate, remove the background of the image",
    },
  ];
