          ...
          {profiles.map(profile => (
            ...
            >
              <div className="h-8 w-8 rounded-sm bg-secondary">
                <img src={profile.imageUrl || ''} alt={`Profile preview`} className="object-cover" />
              </div> 
              ...
              <Button variant="ghost" className='justify-self-end gap-2 -mr-2 px-2'><Trash className='w-4 h-4 text-muted-foreground'/></Button>
            </TabsTrigger>
          ))}
        </TabsList>
        </div>
