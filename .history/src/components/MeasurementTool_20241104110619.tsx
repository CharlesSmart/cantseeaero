...
const MeasurementTool: React.FC<MeasurementToolProps> = ({ imageUrl, onRulerUpdate, onRemoveBG, isBGRemovalLoading }) => {
  ...
  const drawMeasurementTool = useCallback(() => {
    ...
    if (startPoint && endPoint) {
      ...
      ctx.rotate(Math.min(Math.atan2(endPoint.y - startPoint.y, endPoint.x - startPoint.x)-Math.PI, Math.atan2(endPoint.y - startPoint.y, endPoint.x - startPoint.x)));
      console.log(Math.atan2(endPoint.y - startPoint.y, endPoint.x - startPoint.x));
      console.log(Math.atan2(endPoint.y - startPoint.y, endPoint.x - startPoint.x)-Math.PI);
      ctx.fillStyle = 'white';
