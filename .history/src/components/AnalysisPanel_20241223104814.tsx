...
const AnalysisPanel: React.FC<AnalysisPanelProps> = ({
    ...
    <div>
        ...
        {isPanelVisible && (
        <Card className='max-w-xs max-h-[calc(100vh-2rem)] overflow-y-auto fixed left-4 top-4 sidepanel'>
            <CardHeader className='pb-0'>
                <div><img src={Logo} alt="Windtunnel Logo" /></div>
                <Button variant="ghost" onClick={togglePanelVisibility} className='absolute right-2 top-2 opacity-0 sidepanel-hover:opacity-100'>
