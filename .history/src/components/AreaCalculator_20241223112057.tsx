  ...
  return (
    <div className="">
        ...
        <h3 className="text-lg font-semibold">Aero</h3>
          ...
          <DataRowWithInput label={'CdA'} value={cdA?.toFixed(2)} onChange={() => {}} disabled={true} unit={'m²'}/>
          <DataRowWithInput label={'Power'} value={power?.toFixed(0)} onChange={() => {}} disabled={true} unit={'w'}/>
          ...
          <div className='grid grid-cols-2 gap-8 items-center mr-2 mt-2'>
          {/* <span className="text-sm">Power</span><span className='font-mono text-right text-sm'>{power !== null ? power.toFixed(0) : 'N/A'}w</span> */}
          </div>
