  ...
  return (
    <Card className='max-w-xs fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2'>
        ...
        <a className='flex flex-row gap-2 group cursor-pointer pt-2 overflow-hidden' onClick={onLoadDemoProfiles}>
            <div className='border bg-card rounded-md -rotate-2 translate-x-6 translate-y-2 transition-all group-hover:-rotate-3 group-hover:translate-y-1'><img src="/demo/demoImagePreview1.png" srcSet="/demo/demoImagePreview1.png 2x" alt="Example trainer image"  /></div>
            <div className='border bg-card rounded-md rotate-2 -translate-x-6 translate-y-2 transition-all group-hover:rotate-3 group-hover:translate-y-1'><img src="/demo/demoImagePreview2.png" srcSet="/demo/demoImagePreview2.png 2x" alt="Example trainer image"  /></div>
        </a>
      </CardContent>
    </Card>
  );
