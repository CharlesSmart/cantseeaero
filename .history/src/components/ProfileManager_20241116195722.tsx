        ...
        <TabsList>
          ...
          {profiles.map(profile => (
            ...
            >
              ...
              <div onClick={() => onDeleteProfile(profile.id)}  className='h-8 w-8 self-center gap-2 -mr-2 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200'><Trash className='w-4 h-4 text-muted-foreground'/></div>
