        ...
        <TabsList>
          {profiles.map(profile => (
            ...
            >
              ...
              <Button onClick={() => onDeleteProfile(profile.id)} variant="ghost" className='justify-self-end gap-2 -mr-2 px-2 group-hover:opacity-100 transition-opacity duration-200'><Trash className='w-4 h-4 text-muted-foreground'/></Button>
            </TabsTrigger>
          ))}
        </TabsList>
        </div>
