...
const EmptyState: React.FC<EmptyStateProps> = ({ onImageUpload, uploadedImage, onLoadDemoProfiles}) => {
  return (
    <Card className='max-w-xs fixed left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2'>
            ...
            <h2 className='text-lg font-semibold text-center'>Upload an image</h2>    
            <p className='text-sm text-muted-foreground text-center'>or try an example from below for a demo.</p>    
            </CardHeader>  
        <CardContent> 
