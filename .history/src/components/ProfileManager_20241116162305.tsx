              ...
              {profile.pixelCounts &&
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className='max-w-s'>
                      <p>Pixel analysis: {profile.pixelCounts?.opaquePercentage ?? 0}% opaque, <br/> </TooltipContent>{profile.pixelCounts?.semiTransparentPercentage ?? 0}% semi-transparent, {profile.pixelCounts?.transparentPercentage ?? 0}% transparent</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>   
              }
