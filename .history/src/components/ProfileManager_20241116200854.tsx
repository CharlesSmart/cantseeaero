        ...
        <TabsList>
          ...
          {profiles.map(profile => (
            ...
            >
              ...
              <div onClick={() => onDeleteProfile(profile.id)}  className='flex h-8 w-auto self-center content-center justify-end gap-2 px-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200'><Trash className='w-4 h-4 text-muted-foreground self-center'/></div>
