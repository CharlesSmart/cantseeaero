          ...
          {profiles.map(profile => (
            ...
            >
              ...
              <div className='grid grid-cols-3'>
                ...
                <span><div className="h-2 w-2 rounded-full bg-primary opacity-50"></div>{Math.round(profile.pixelCounts?.transparentPercentage ?? 0)}%</span>
                <span><div className="h-2 w-2 rounded-full bg-muted"></div>{Math.round(profile.pixelCounts?.semiTransparentPercentage ?? 0)}%</span>
              </div>
              }
