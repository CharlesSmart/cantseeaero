...
export const DataRowWithInput: React.FC<{
    ...
    return (
        <div className='grid grid-cols-2 gap-8 text-sm text-secondary-foreground items-center'>
            ...
            <Input value={value !== undefined ? value : ''} onBlur={onChange} className='w-20 justify-self-end font-mono disabled:text-secondary-foreground disabled:opacity-100' disabled={disabled} />
