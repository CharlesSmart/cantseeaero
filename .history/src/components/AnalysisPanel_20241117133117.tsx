    ...
    return (
        ...
        <hr className='-mx-6'></hr>
            <div className='flex flex-col gap-2'>
                ...
                <DataRowWithInput label={'Measured length'} value={measurementPixels ?? ' '} onChange={() => {}} onBlur={() => {}} disabled={true} unit={'px'}></DataRowWithInput>
                <DataRowWithInput label={'Known length'} value={measurementMm ?? ' '} onBlur={handleActualLengthChange} onChange={() => {}} disabled={false} unit={'mm'}></DataRowWithInput>
                <hr></hr>
