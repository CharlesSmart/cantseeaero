              ...
              {profile.pixelCounts &&
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className='max-w-sm'>
                      <p>Pixel analysis:<br /> {profile.pixelCounts?.opaquePercentage ?? 0}% opaque, <br /> {profile.pixelCounts?.semiTransparentPercentage ?? 0}% semi-transparent, <br /> {profile.pixelCounts?.transparentPercentage ?? 0}% transparent</p>
                    </TooltipContent>
                  </Tooltip>
                </TooltipProvider>   
              }
